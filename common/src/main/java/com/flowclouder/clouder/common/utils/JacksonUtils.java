...
import com.flowclouder.clouder.common.exception.runtime.ClouderDeserializationException;
import com.flowclouder.clouder.common.exception.runtime.ClouderSerializationException;
...
public final class JacksonUtils {
    ...
    public static String toJson(Object obj) {
        try {
            ...
            throw new ClouderSerializationException(obj.getClass(), e);
        }
    }
    ...
    public static <T> T toObj(byte[] json, Class<T> cls) {
        try {
            ...
            throw new ClouderDeserializationException(cls, e);
        }
    }
    ...
    public static <T> T toObj(byte[] json, Type cls) {
        try {
            ...
            throw new ClouderDeserializationException(e);
        }
    }
    ...
    public static <T> T toObj(String json, TypeReference<T> typeReference) {
        try {
            ...
            throw new ClouderDeserializationException(typeReference.getClass(), e);
        }
    }
    ...
    public static <T> T toObj(InputStream inputStream, Type type) {
        try {
            ...
            throw new ClouderDeserializationException(type, e);
        }
    }
