...
/**
 * Clouder runtime exception
 * @author kingkiller
 */
public class ClouderRuntimeException extends RuntimeException {
    ...
    public ClouderRuntimeException(int errCode) {
        super();
        this.errCode = errCode;
    }

    public ClouderRuntimeException(int errCode, String errMsg) {
        super(String.format(ERROR_MESSAGE_FORMAT, errCode, errMsg));
        this.errCode = errCode;
    }

    public ClouderRuntimeException(int errCode, Throwable throwable) {
        super(throwable);
        this.errCode = errCode;
    }

    public ClouderRuntimeException(int errCode, String errMsg, Throwable throwable) {
