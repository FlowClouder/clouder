...
import com.flowclouder.clouder.common.spi.ClouderServiceLoader;
...
public class AuthPluginManager {
    ...
    private static AuthPluginManager INSTANCE = new AuthPluginManager();
    ...
    private void initAuthServices() {
        Collection<AuthPluginService> authPluginServices = ClouderServiceLoader.load(AuthPluginService.class);
